...
do not affect the satisfaction of $P$. However, as with realistic problems, 
there could be other properties that cover such portion of the model.
\ela{added the above description. review/edit please}
...
\begin{figure}[t]
 \centering
  ...
  \label{fig:ivcs}
  \vspace{-0.1in}
  \caption{Graphical representation of IVCs for the model in Fig.\ref{fig:asw}
