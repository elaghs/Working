...
We examine \textbf{Grow-Shrink}, the algorithm presented in this paper, and the two state-of-the-art algorithms (briefly described in Section~\ref{sec:existing-techniques}): \textbf{Offline MARCO}, the algorithm from~\cite{Ghass17AllIVCs}, and \textbf{Online MARCO}, a variant of the algorithm from~\cite{Ghass17AllIVCs} that performs a shrink step prior to returning a solution to ensure minimality.
