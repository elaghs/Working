...
no formal description of the models, metrics, algorithms, or experimental results are provided.%, nor in fact are any concrete metrics specified. In addition, no implementations or experimental results are provided, so it is not possible to compare their approach and ours.
