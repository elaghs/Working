...
\title{Efficient Generation of Inductive Validity Cores for Safety Properties\titlenote{This work was funded by DARPA under contract
FA8750-12-9-0179 (Secure Mathematically-Assured Composition of Control
Models) and by NASA under contract NNA13AA21C (Compositional Verification of Flight Critical Systems).}}
\numberofauthors{3}
...
\printccsdesc 
\keywords{Auto-traceability, Inductive Validity Core, UNSAT Core, $k$-Induction}
