...
\end{corollary}
\begin{IEEEproof}
  Immediate from Lemma \ref{lem:adeq}. \mike{Note the ??}
\end{IEEEproof}
%\begin{IEEEproof}
...
any inadequate set (by \mike{Why is this ??} Corollary~\ref{lem:adeq}). Thus the \mivc\ must
...
However, by maximality and \mike{Why is this ??} Lemma~\ref{lem:adeq}, an \mis~ can never be
