...
\begin{itemize}
    \item \textbf{RQ1:} How expensive is it to compute inductive validity cores using the \bfalg\ and \ucalg\ algorithms?
    \item \textbf{RQ2:} How close to minimal are the support sets computed by \ucalg\ as opposed to the (guaranteed minimal) \bfalg?
