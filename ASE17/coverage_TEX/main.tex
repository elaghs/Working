...
% *** MATH PACKAGES ***
%
\usepackage[textwidth=18.4cm,textheight=23.5cm]{geometry}
...
\newcommand{\expr}{\phi}
\newcommand{\exprS}{\Phi}
\newcommand{\nondetcov}{{\small \text{\sc Nondet-Cov}}}
\newcommand{\nondetcovalt}{{\small \text{\sc Nondet-Cov$^{*}$}}}
\newcommand{\ivccov}{{\small \text{\sc IVC-Cov}}}
\newcommand{\maycov}{{\small \text{\sc May-Cov}}}
\newcommand{\mustcov}{{\small \text{\sc Must-Cov}}}
\newcommand{\allcov}{{\small \text{\sc Model-Cov}}}
\newcommand{\mutcov}{{\small \text{\sc Mutant-Cov}}}
...
\author{\IEEEauthorblockN{Elaheh Ghassabani\IEEEauthorrefmark{1},
Andrew Gacek\IEEEauthorrefmark{2}, Michael W. Whalen\IEEEauthorrefmark{1},
Mats P. E. Heimdahl\IEEEauthorrefmark{1}, Lucas Wagner\IEEEauthorrefmark{2}}
\IEEEauthorblockA{\IEEEauthorrefmark{1} Department of Computer Science \& Engineering,
University of Minnesota,
MN, USA\\
\IEEEauthorrefmark{2} Rockwell Collins,
Advanced Technology Center,
IA, USA\\
Email: \IEEEauthorrefmark{1}ghass013, mwwhalen, heimdahl@umn.edu,
\IEEEauthorrefmark{2}andrew.gacek, lucas.wagner@rockwellcollins.com }
...
\begin{abstract}
 When using formal verification on critical software, an important question involves whether
we have we specified enough properties for a given implementation model. To address
...
\begin{IEEEkeywords}
Coverage, requirements completeness, formal verification,
...
%{\small \textbf{Acknowledgments:} This work was carried out within the HACMS and SOSITE Phase II grants (DARPA FA8750-12-9-0179 and FA8650-16-C-7656).}
