...
%\subsection{Tooling}
%
The three introduced algorithms have been implemented in the \texttt{JKind} model checker~\cite{jkind,NFM2012:CoGaMiWhLaLu,Spear}. %, which is an infinite-state industrial model checker.
