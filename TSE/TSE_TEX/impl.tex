...
We have implemented all of the inductive validity core algorithms from the previous section in an industrial model checker called \texttt{JKind} ~\cite{jkind} \mike{Update reference to ArXiV JKind Tools paper},
