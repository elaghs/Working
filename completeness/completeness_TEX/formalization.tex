...
\]
\end{definition}
Note that without loss of generality, the formalization considers a single property P, which can be viewed as the conjunction of all the properties of the model.
