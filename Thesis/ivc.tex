...
\label{sec:onaivc}
This section describes a collaborative work with Masaryk University (Bendik et al. \cite{Jar2017}). We present an online approach for enumerating all MIVCs.
\input{growshrink}
