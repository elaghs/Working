...
$E_N$ with a new set of edges $E^{v_i}_M$ in the mutated net-list. Therefore, given $N = (V_N,E_N, \tau_N)$,
$v_i \in V_N$ is covered by property $P$ when $P$ is 
satisfied by $N$ and violated by $(V_N, E^{v_i}_M, \tau^{v_i}_{N})$. Then, coverage is measured by how many of the mutated
models are “killed” by the property. 
