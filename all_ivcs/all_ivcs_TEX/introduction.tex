...
It is often the case that there are multiple IVCs for a given property.  In this case, the algorithms from~\cite{Ghass16} give, at best, an incomplete picture of the traceability information associated with the proof.  It it is possible to gather {\em all} IVCs, then several additional analyses can be performed: 
\begin{description}
