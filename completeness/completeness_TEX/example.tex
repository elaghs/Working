...
\label{sec:example}
\ela{I'm not sure if we need this section or not. I have an abstract example in the discussion section. 
if we want to have this section, I think we should put it after background, or maybe the method section. Also we need to provide a very brief explanation on Lustre syntax. I haven't had time yet to come up with a good example...}
