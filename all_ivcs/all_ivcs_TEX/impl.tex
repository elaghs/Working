...
As mentioned in Theorem~\ref{thm:minimal-hard}, finding a minimal IVC is as hard as model checking, 
...
results. if a timeout occurs, we report a warning to users that the results may be 
approximate.
