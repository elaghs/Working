...
\title{Efficient Generation of Inductive Validity Cores for Safety Properties\titlenote{\ela{PLEASE FILL IN...}}}
\numberofauthors{3}
...
%\vspace{0.05in}
\textbf{Acknowledgments:} This work was funded by DARPA under contract
