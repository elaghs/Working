...
insight to the user. Recently, the notion of a minimal Inductive Validity Core
(IVC) was introduced to trace a property to a minimal set of model elements
...
This paper proposes an efficient method for finding all minimal IVCs of a
