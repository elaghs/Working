...
\ela{you've already added back \nondetcov. should it be \nondetcovalt ? \\ also there was a lemma saying \nondetcov and \nondetcovalt are the same, whose proof it's not really obvious to me. I think if we call this one \nondetcovalt , we need to be more specific about $TS$ and other things...}
