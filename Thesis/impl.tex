...
All of the inductive validity core algorithms presented in Chapter \ref{ch:ivc} have been implemented in an industrial model checker called \texttt{JKind} ~\cite{jkind},
