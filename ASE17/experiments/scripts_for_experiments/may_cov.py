...
###################################################################### 
plt.plot(x_axis, sorted_may, '--ms' , markersize=7, label=LEGENDS[0])
plt.plot(x_axis, sorted_uc, ':b+' , markersize=9, label=LEGENDS[1]) 
plt.plot(x_axis,  sorted_must, ':gx', markersize=9, label=LEGENDS[3])
plt.plot(x_axis, sorted_ucbf , '-k.' , markersize=5, label=LEGENDS[2]) 
########################################################################################
