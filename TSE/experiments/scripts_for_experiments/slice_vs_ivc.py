...
for item in sorted_dic:
    ...
    sorted_slices.append(slices[item['id']]) 
...
ax = plt.subplot(111)    
######################################################################  
plt.plot(x_axis, sorted_ucbf , ':.b' , markersize=7, label=LEGENDS[2]) 
plt.plot(x_axis,  sorted_slices, ':+g', markersize=7, label=LEGENDS[0])  
plt.plot(x_axis, sorted_uc, '--mx' , markersize=5, label=LEGENDS[1])
########################################################################################
