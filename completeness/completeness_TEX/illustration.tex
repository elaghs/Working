...
%One might think that at least the definitions of the `below' or `above' would be necessary, but because the specification used the model variables \aonebelow, \atwobelow, \aoneabove, and \atwoabove, the chosen threshold values do not matter.  
