...
Now, we turn to the problem of finding {\em all} minimal IVCs.  

In general, IVCs are not unique, and there are several benefits to computing

By definition, this approach allows us to find the {\em minimum} IVC in terms of number of elements (which may not be unique), and it allows us to explore the {\em diversity} of proofs for a particular property.
