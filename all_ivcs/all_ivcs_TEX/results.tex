...
For small models, much of this penalty is due to starting many instances of the SMT solver; if we examine models that require $\geq 1s$ of analysis time, the mean overhead of \aivcalg\ over the baseline analysis drops from 31.3x to 9.7x.
