...
Verification is based on k-induction and property directed reachability using a back-end SMT solver.
In the
...
executes the \ucalg ~algorithm \cite{Ghass16} to generate a nearly minimal IVC. To implement our method, we have made use of this engine and also extended \texttt{JKind} with a new engine that
