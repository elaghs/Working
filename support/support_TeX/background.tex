...
require additional lemmas of its own. \mike{Should we mention that 
PDR/IC3 can be viewed in this way?}
...
\label{subsec:jkind}
\andrew{AJG: I think we should move this section to implementation.
