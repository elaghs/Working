...
\begin{table}
  ...
  \begin{tabular}{ |c||c|c|c|c| }
    ...
    \aivcalg\ minimum IVC & 1  & 134  & 12.078 & 15.550 \\[0.5ex]
    \hline
    \end{tabular}
  \label{tab:ivcsize}
\end{table}
