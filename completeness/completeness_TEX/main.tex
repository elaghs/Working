...
\title{A Justifiable Notion of Coverage in Formal Verification}
...
test suite adequacy in testing well-addressed by different coverage metrics. 
...
We present and implement an efficient algorithm for doing so based
...
\begin{IEEEkeywords}
  coverage; requirement completeness; formal verification; SAT-based model checking; 
