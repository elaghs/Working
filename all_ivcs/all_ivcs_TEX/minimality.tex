...
\mike{The proof below seems a bit informal.  Moreover, as best I can tell, Lemma 3, corollary 2, Theorem 1, and Theorem 2 all work without modification.  Theorem 1 is a bit informal - the set A {\em contains} all IVCs but can contain more.  As written, I think the proof works either way.}
