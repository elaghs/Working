...
\ela{\\what do you mean by average increase (I know we calculated it for the previous paper, but sorry I don't remember what it was exactly)? if you can show me with some data how you would calculate it, I'll give you the number. I assume the number used in the previous paper was for the old UCBF algorithm. But I have some data already in table 3 which might be useful for here}

\ela{Maybe we should talk about statistics in the implementation, not here.}
